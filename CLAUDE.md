...
`DESIGN.md` is the working map of the system as built — read it first for
orientation, then the four sources above for authority. Older files in
`docs/` outside `docs/design/` still describe the pre-rebuild system.
